...
urlpatterns = [
    ...
    path('main-page/<str:bookcategory_slug>/', BookCategoryDetail.as_view(), name='bookcategory_page'),

    path('add_to_wishlist/<str:book_slug>/', AddToWishList.as_view(), name='add_to_wishlist'),
    path('remove_from_wishlist/<str:book_slug>/', DeleteFromWishList.as_view(), name='remove_from_wishlist'),
    ...
    path('account_page/account/', AccountView.as_view(), name='account_page'),
    ...
    path('account_page/checkout_history/', CheckoutsHistoryView.as_view(), name='checkouts_page'), 
